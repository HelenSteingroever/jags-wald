!define APP_NAME "JAGS-wald"
!define PUBLISHER "JAGS-wald"

;Name used for JAGS Wald module registry keys
...
!define UNINSTALL_LOG "Uninstall-wald"
...
Section #Default section
   ...
   WriteRegStr ${INSTDIR_REG_ROOT} "${INSTDIR_REG_KEY}" "URLInfoAbout" "https://github.com/HelenSteingroever/jags-wald"
...
Section "32-bit installation" Sec32
   ...
   File /r inst32\lib\JAGS\modules-${MAJOR}\wald*
...
Section "64-bit installation" Sec64
   ...
   !insertmacro UNINSTALL.LOG_OPEN_INSTALL
   File /r inst64\lib\JAGS\modules-${MAJOR}\wald*
   !insertmacro UNINSTALL.LOG_CLOSE_INSTALL
